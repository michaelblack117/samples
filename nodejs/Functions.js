...
const client = new AgencyServiceClient(new Credentials(
  "37bfeee3edebf2818aa44fda842530ad7bf060ea34261376028e59947b6de4f1", // access token
...
const createOrganization = async (name) => {
  try {
    let organization = await client.createTenant({
      body: {
        name: name,
...
const createSchema = async (name, version, attrNames) => {
  try {
